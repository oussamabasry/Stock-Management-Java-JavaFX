...
public class SaleHomeWindow {
    protected ICustomerDao customerDao = new CustomerDaoImpl();
    protected SaleHomeHandler handler = new SaleHomeHandler(this);
    ...
    protected Button addBlButton = new Button("Sales Management");
    protected Scene scene = new Scene(root);
    protected Stage window = new Stage();
    protected Label titleLabel = new Label("  Choose a customer");
    ...
    protected void addNodesToWindow() {
        ...
        crudActionsHBox.getChildren().addAll(displayAllCustomersButton, addBlButton);
